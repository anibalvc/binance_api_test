...
class AppColors {
  ...
  static const blueNoticias = Color(0xffe3e7ef);
  static const binanceBlack = Color(0xff333F4F);
  static const binanceSecondaryBlack = Color(0xff47586E);
...
final myTheme = ThemeData(
  primaryColor: AppColors.binanceBlack,
  colorScheme: const ColorScheme.light(
    primary: AppColors.binanceBlack,
    secondary: AppColors.binanceBlack,
  ),
  cardTheme: CardTheme(
  ...
  scaffoldBackgroundColor: AppColors.binanceBlack,
  iconTheme: const IconThemeData(size: 30, color: AppColors.white),
  textSelectionTheme: const TextSelectionThemeData(cursorColor: Colors.black),
  appBarTheme: const AppBarTheme(
    elevation: 3,
    backgroundColor: AppColors.binanceBlack,
